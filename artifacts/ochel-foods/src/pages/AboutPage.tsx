...
const values = [
  ...
  { icon: Star, title: "Bold Authentic Flavors", desc: "We celebrate Nigerian food culture by infusing authentic local flavors into every recipe, from our Suya Pizza to our Zobo drink." },
  { icon: Users, title: "Community First", desc: "O'chel was built for our community. We support local ingredients and believe food brings people together." },
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <p className="font-[Montserrat] text-gray-600 max-w-2xl mx-auto text-base leading-relaxed">
              Born from a deep love for food and a desire to bring bold, authentic Nigerian flavors to your doorstep — with a modern, exciting twist.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="space-y-4 font-[Montserrat] text-gray-600 text-sm leading-relaxed">
                <p>
                  O'chel Foods was born from a passion for delivering bold, authentic Nigerian flavors with a modern twist. We believe that great food should be fun, fresh, and fast — delivered right to your door with a smile.
                </p>
                <p>
                  Our name, O'chel, reflects our spirit — vibrant, warm, and full of character. From our signature Suya Pizza that fuses beloved Nigerian street food with Italian tradition, to our freshly baked banana breads and crispy small chops, every item on our menu is a celebration of flavor.
                </p>
                <p>
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
              className="bg-[#E8192C] rounded-3xl p-10 text-center"
              style={{ backgroundImage: `url(${speckleBg})`, backgroundSize: "cover" }}
            >
              <div className="bg-[#E8192C]/90 rounded-2xl p-8">
                ...
                <p className="font-chewy text-2xl text-white leading-relaxed">
                  "Bold Flavors. Fast Delivery. Real Nigerian Food."
                </p>
                <div className="mt-6 pt-6 border-t border-white/20">
                  <p className="font-[Montserrat] text-white/80 text-sm">Reach us on WhatsApp or Instagram</p>
                  <a
                    href="https://wa.me/2349056351651"
                    target="_blank"
                    rel="noopener noreferrer"
                    data-testid="link-whatsapp-about"
                    className="block mt-2 text-[#FFB800] font-bold font-[Montserrat] text-lg hover:underline"
                  >
                    +234 905 635 1651
                  </a>
                  <a
                    ...
                    className="block mt-1 text-[#FFB800] font-bold font-[Montserrat] hover:underline"
                  >
                    @Ochel_ng
                  </a>
                </div>
